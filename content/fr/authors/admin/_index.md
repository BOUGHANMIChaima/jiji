...
Passionnée par l'IA, elle pratique du Prompt engineering sur des LLMs (Chatgpt, Mistral, Claude, Gemini,..), en les testant sur des solutions basées sur l'IA couplées à des approches RAG pour l'exploitation et l'analyse de données métiers. 
Ses dernières missions qu'elle entreprend, comprend de l'expertise qui tourne autour la mise en œuvre de modèles d'apprentissage automatique (ML) tels que Random Forest et XGBoost pour résoudre les problèmatiques clients ainsi que le développement de modèles d'attribution en utilisant des chaînes de Markov. Elle crée des tableaux de bord et des graphiques interactifs avec Shiny pour améliorer la visualisation des données. En outre, elle a travaillé sur les méthodes de calcul des synergies pour les modèles multiplicatifs dans le cadre d'une Modélisation du Marketing Mix (MMM) et sur l'estimation des modèles bayésiens à l'aide de PySTAN et des méthodes de Monte Carlo par chaîne de Markov (MCMC).  
...
Elle a également eu l'occasion, grâce à son stage d'ingénieur, à ses deux stages de fin d'études et à ses projets académiques, de comprendre les questions d'analyse de données qui l'intéressaient particulièrement et d'acquérir de l'expérience dans ce domaine.  
...
Elle a une très bonne maîtrise des langages de programmation, en particulier Python, R et R/shiny. Elle a été membre de [R-Ladies Tunis](https://www.meetup.com/rladies-tunis/) lorsqu'elle était étudiante et est actuellement l'une des organisatrices de [R-Ladies Paris](https://www.meetup.com/fr-FR/rladies-paris/). 
Elle maîtrise également SQL, SAS et évidemment Latex et Git.  
